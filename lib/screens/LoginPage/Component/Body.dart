...
class Body extends StatelessWidget{
  final bool saving;//to circular progress bar
  ...
  final bool obscureText;//contraseñaOculta
  ...
  final ValueChanged<void> onLoginStatusChanged;

  Body({Key key,this.toggle,this.saving,this.obscureText,this.onLoginStatusChanged}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return ModalProgressHUD(color: Colors.grey[600],progressIndicator: CircularProgressIndicator(valueColor: AlwaysStoppedAnimation<Color>(Colors.black),),inAsyncCall: _saving, child: Column(
