...
class CuentasBodyPage extends StatefulWidget {
  Function callback,callbackloading,callbackfull;
  CuentasBodyPage({Key key,this.callback,this.callbackloading,this.callbackfull})
      : super(key: key);
  static Route<dynamic> route() {
    return MaterialPageRoute(
      builder: (context) => CuentasBodyPage(),
    );
  }
  @override
  _CuentasBodyPageState createState() => _CuentasBodyPageState();
}

class _CuentasBodyPageState extends State<CuentasBodyPage> {
